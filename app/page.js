...
<main className="bg-black ">
	<div ref={containerRef} className="relative h-[200vh] ">
		...
		<motion.div className="relative w-full h-full" style={{ scale }}>
			...
			<div className="text-zinc-300 font-[Main] md:text-xs text-sm text-center pt-14 md:px-20 md:pt-12 leading-relaxed ">Rebuilding the portfolio. Updates coming soon.</div>
